...
**Trigger**: Emma posts an architecture assignment in #pm-tasks

1. Acknowledge in #pm-tasks: "Received. Starting design."
...
Post to #architecture when complete.
...
Post to #architecture. ADRs are committed to the repository under `docs/adrs/`.
...
3. Post the updated design to #architecture with a summary of changes
